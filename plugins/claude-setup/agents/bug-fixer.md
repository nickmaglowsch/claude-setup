---
name: bug-fixer
description: "Fixes a diagnosed bug using adaptive TDD: writes a failing test, implements the fix, and verifies no regressions. Reads $TASKS_DIR/bug-diagnosis.md. Spawned by /claude-setup:debug-workflow."
