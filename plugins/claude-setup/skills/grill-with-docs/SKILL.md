...
A short bulleted summary of the resolved decisions and any deferred questions, plus a list of the files updated (`CONTEXT.md`, new ADRs). Then offer to invoke `/claude-setup:build` with the resolved plan as the PRD seed.
